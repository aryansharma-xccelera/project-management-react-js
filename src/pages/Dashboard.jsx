...
const Dashboard = () => {
    ...
    return (
        <div className='max-w-6xl mx-auto'>
            <div className="mb-6 rounded border border-blue-200 bg-blue-50 px-4 py-3 text-sm font-medium text-blue-700 dark:border-blue-900 dark:bg-blue-950/50 dark:text-blue-300">
                Verified by dev-qa new architecture test.
            </div>
